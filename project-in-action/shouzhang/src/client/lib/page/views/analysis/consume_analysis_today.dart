 ...
 * @LastEditors: gui-qi
 * @LastEditTime: 2022-11-26 05:11:24
 * @Description: 
 * 
...
class TodayAnalysis extends StatelessWidget {
  ...
  final Future<double> todayConsume = ConsumeAnalysisService().getTodayTotalCunsume();
  final Future<double> todayBudget = BudgetAnalysisService().getTodayTotalBudget();
